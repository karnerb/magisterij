...
void LC_Elastomer::break_molecules(int count){
...
void LC_Elastomer::initialize_lattice_random(){
...
void LC_Elastomer::initialize_lattice_parallel(){
...
void LC_Elastomer::break_molecule(int I){
...
void LC_Elastomer::align_molecule(int I){
...
void LC_Elastomer::make_one_cluster(int a){
...
void LC_Elastomer::make_two_clusters(int a){
...
void LC_Elastomer::checkerboard_pattern(){
...
void LC_Elastomer::make_empty_cube_cluster(int a){
...
void LC_Elastomer::make_L_shaped_cluster(int a, int b){
